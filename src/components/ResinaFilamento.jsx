            ...
            <div className="contenedor sobre-nosotros" id="diferencia-resina-filamento">
                ...
                <div className="contenedor-sobre-nosotros">     
                    ...
                    <div className="contenidos-textos">
                        ...
                        <h3 className='dark:text-slate-300'><span className="circulo-violeta">1</span>Resina</h3>
                        ...
                        <h3 className='dark:text-slate-300'><span className="circulo-violeta">2</span>Filamento</h3>
                        <ul className='dark:text-slate-300'>
